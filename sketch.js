...
function preload(){
girlImg = loadImage("test/girl.png");
nightImg = loadImage("test/night.png");
zombieImg = loadImage("test/zombie.png");
barriersImg = loadImage("test/barriers.png");
blastImg = loadImage("test/blast.png");
you_lose = loadImage("test/gameover.png");
restartImg = loadImage("test/reset.png");
